...
import uz.java.demo.dto.BookWithAuthorDto;
...
public interface BookRepository extends JpaRepository<Book, Long> {
    @Query("select new uz.java.demo.dto.BookWithAuthorDto(a, b.id, b.name, b.price, b.rate, b.categoryId, b.filePath, b.ISBN_10, b.description, b.languageId) " +
            "from Book b join Author a on b.authorId = a.id where b.id = :id")
    BookWithAuthorDto getBookWithJoin(@Param("id") Long id);
    ...
    List<BookWithAuthorDto> findAllByAuthorName(@Param("name") String name);

    @Query("select new uz.java.demo.dto.BookWithAuthorDto(a, b.id, b.name, b.price, b.rate, b.categoryId, b.filePath, b.ISBN_10, b.description, b.languageId) " +
            "from Book b join Author a on b.id = a.id where b.ISBN_10=:isbn")
    List<BookWithAuthorDto> findAllByISBN_10(@Param("isbn") String isbn);

    @Query("select new uz.java.demo.dto.BookWithAuthorDto(a, b.id, b.name, b.price, b.rate, b.categoryId, b.filePath, b.ISBN_10, b.description, b.languageId) " +
            "from Book b join Author a on b.id = a.id where a.name like(CONCAT('%',:name,'%')) and b.ISBN_10=:isbn")
    List<BookWithAuthorDto> findAllByAuthorNameAndISBN_10(@Param("name") String name, @Param("isbn") String isbn_10);
